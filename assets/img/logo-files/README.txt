...
How to unzip your logo file.
Click right on your mouse, and select "Extract all". A pop-up window will open, and you can click on "Extract" again. You will find the file in your Downloads tab.
...
The provided files are suitable for web use: websites, blogs, social media profile pictures, emails, etc.
...
You might have seen JPG files with blurred borders and of poor quality. A vector file never deals with that. Vector files are mathematically calculated to adapt perfectly to all sizes. Vector files are commonly used for printing.  
